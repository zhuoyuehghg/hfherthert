...
补充一下，2024.ml本是我为herokuvless使用者最为备用方案提供的，我不建议大量传播。近期有部分用户制作视频或者以其他形式把站点发布到youtube等，导致访问量过大，由原来每日几百ip暴增到，这两天每天都有三四千ip，新增几百注册用户。这里我欢迎你制作heroku的视频教程，不过2024尽量不要公开宣传，容易被墙不说，新用户暴增也会影响到原有用户使用体验。推荐首选自建。
